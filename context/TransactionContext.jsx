...
//         message: transaction.message,
//         keyword: transaction.keyword,
//         amount: parseInt(transaction.amount._hex) / (10 ** 18) // Convert from Wei to ETH
//       }));
...
//       if (accounts.length) {
//         setCurrentAccount(accounts[0]);
//         getAllTransactions(); // Fetch transactions after wallet is connected
//       } else {
//         console.log("No accounts found");
//       }
//     } catch (err) {
...
//       // Fetch the updated transaction count and update state without reloading
//       const transactionsCount = await transactionsContract.getTransactionCount();
//       setTransactionCount(transactionsCount.toNumber());
...
//         handleChange,
//         formData,
//         error // Pass the error state to the context
//       }}
//     >
//       {children}
//     </TransactionContext.Provider>
